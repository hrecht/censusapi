...
To see a current table of every available endpoint, use`listCensusApis()`. This data frame includes useful information for making your API call, including the dataset's name, description and title, as well as a contact email for questions about the underyling data.
...
* Email the Census Bureau API team at census.data@census.gov for questions relating to the underlying data and APIs. You can also reach out to the contact listed in the dataset metadata found in `listCensusApis()` for questions about a specific survey.
