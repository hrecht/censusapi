...
## API key setup
`censusapi` recommends but does not require using an API key from the U.S. Census Bureau. The Census Bureau may limit the number of requests made by IP address if you do not use an API key.
