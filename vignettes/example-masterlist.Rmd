...
Get the annaul median household income in inflation-adjusted 2019 dollars for Alabama cities for the past five years.
```{r}
...
The QWI endpoints allow both simple calls and very specfic ones. Make sure to read the documentation closely.
