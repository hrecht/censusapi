...
[County Business Patterns](https://www.census.gov/data/developers/data-sets/cbp-nonemp-zbp/cbp-api.html)
```{r, purl = NOT_CRAN, eval = NOT_CRAN}
...
[Zip Codes Business Patterns](https://www.census.gov/data/developers/data-sets/cbp-nonemp-zbp/zbp-api.html)
```{r, purl = NOT_CRAN, eval = NOT_CRAN}
...
[Nonemployer statistics](https://www.census.gov/data/developers/data-sets/cbp-nonemp-zbp/nonemp-api.html)
```{r, purl = NOT_CRAN, eval = NOT_CRAN}
